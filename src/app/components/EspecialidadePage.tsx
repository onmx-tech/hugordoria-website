  ...
  return (
    ...
    <div ref={pageRef} className="w-full overflow-x-clip">
      ...
      >
        ...
        <span
          data-hero-index
          className="absolute z-[2] font-['Geist',sans-serif] text-cream/[0.04] select-none pointer-events-none"
          style={{
        ...
        >
          ...
          <p
            data-hero-reveal
            className="font-['Arimo',sans-serif] text-cream/50"
            style={{
              margin: 0,
                ...
                <div data-reveal style={{ marginTop: "clamp(48px, 6vh, 72px)" }}>
                  ...
                  <div className="flex flex-col" style={{ marginTop: 24 }}>
                    {card.highlights.map((h, i) => (
                      ...
                      >
                        <span
                          className="font-['Geist',sans-serif] text-gold-light/40 shrink-0"
                          style={{
                        ...
                        <span
                          className="font-['Arimo',sans-serif] text-cream/70"
                          style={{
                          ...
                          <p
                            ...
                            className={
                              isOpening
                                ...
                                : "font-['Arimo',sans-serif] text-cream/60"
                            }
                            style={{
                              margin: 0,
                              fontWeight: 400,
            ...
            {prevCard ? (
              ...
              >
                ...
                >
                  ...
                  <span
                    className="font-['Geist',sans-serif] text-cream group-hover:text-gold-light transition-colors duration-300"
                    style={{
                      fontSize: "clamp(20px, 2vw, 28px)",
                      fontWeight: 400,
                      lineHeight: 1.2,
