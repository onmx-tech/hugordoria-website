  ...
  return (
    ...
    >
        ...
        <div className="col-span-12 lg:col-span-5 xl:col-span-4">
          ...
          >
            <a
              ...
              className="cta-luz rounded-full px-4 py-2.5 sm:px-5 sm:py-3 text-[13px] sm:text-[14px] lg:text-[15px] font-medium leading-none tracking-[-0.01em] whitespace-nowrap"
              style={{
      ...
      <div className="relative z-10 mt-auto w-full">
        ...
        {/* O "DR." NÃO é texto: o letreiro inteiro são contornos, e escrever
            duas letras com fonte viva ao lado de letra vetorizada denuncia a
            emenda no primeiro peso diferente. Os glifos abaixo são o MESMO D e
            o MESMO R de "DORIA", reposicionados — desenho idêntico por
            construção. O ponto é um círculo com o diâmetro da haste do "I"
            (34,56), medido no próprio arquivo.
            Layout (unidades do viewBox): D em 0, R em 196, ponto em 387,5, e o
            "HUGO DORIA" original deslocado 580 à direita. O viewBox cresce de
            1858 para 2438, então o letreiro continua sangrando de ponta a
            ponta — só fica proporcionalmente menor, que é o comportamento
            certo para uma assinatura com mais caracteres. */}
        <svg
          data-hero="wordmark"
          viewBox="0 0 2438 238"
          className="block w-full h-auto"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          aria-label="Dr. Hugo Doria"
        >
          <g transform="translate(-982.928 0)">
          ...
          <g transform="translate(-1209.78 0)">
          ...
          <circle cx="404.8" cy="215.04" r="17.28" fill="var(--color-accent-gold-light)" />
