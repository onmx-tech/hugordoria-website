...
export const CARDS_TEXT: Record<string, CardText> = {
  ...
  "neuralgia-do-trigemeo": {
    ...
    detailedDescription:
      "Trigeminal neuralgia is one of the most intense pains known in medicine, characterized by sudden, lancinating episodes of pain on one side of the face. It is usually caused by compression of the trigeminal nerve by a blood vessel at the base of the skull. Microvascular decompression (Jannetta technique) consists of moving the vessel away from the nerve through a retrosigmoid craniotomy.",
  },
  "espasmo-hemifacial": {
    ...
    detailedDescription:
      "Hemifacial spasm consists of involuntary and repetitive contractions of the muscles on one side of the face, usually starting around the eye and progressing to the mouth. In most cases, it is caused by compression of the facial nerve by an artery at the exit of the brainstem. Dr. Hugo Doria performs this procedure with continuous neurophysiological monitoring.",
  },
