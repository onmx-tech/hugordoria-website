...
export const SOBRE_MIM = {
  ...
  pilares: [
    {
      ...
      texto:
        "Neurocirurgião no BP - A Beneficência Portuguesa de São Paulo, Hospital Santa Catarina - Paulista, Hospital Israelita Albert Einstein e Hospital Sírio-Libanês.",
    },
    {
      titulo: "Publicações e Pesquisa",
      texto:
        "Publicações em periódicos nacionais e internacionais de neurocirurgia, com atuação como revisor ao longo da carreira e participação ativa em atividades de ensino, pesquisa e formação em neurocirurgia.",
    },
    {
  ...
  bio: [
    ...
    "Doutor (PhD) em Neurologia e Neurociência com Tese de Doutorado sobre Aneurismas Cerebrais, pela Universidade Federal de São Paulo (UNIFESP), com o trabalho do doutorado publicado como artigo científico em revista internacional: World Neurosurgery (2022). Meu propósito de vida é a busca incessante pelo tratamento microneurocirúrgico dos meus pacientes, sempre aliando a técnica microcirúrgica ao trato humanizado e à dedicação exclusiva a cada paciente.",
  ...
  experienciaInternacional: [
    ...
    {
      titulo:
        "International Fellowship Visiting Scholar — Neurocirurgia Vascular e Tumores Cerebrais",
